...
LicenseCode = '91CD2400-B36A-4FAE-8AD9-8E3E80D8B902'
UserName =  'JW6058'
...
#important: gettext has to be true, set outputformat to xlsx
RequestUrl = "http://www.ocrwebservice.com/restservices/processDocument?gettext=true&outputformat=xlsx"
...
directory = os.getcwd()
FilePath = directory+"/test_pdf.pdf"
...
if r.status_code == 401:
    ...
    print("Your OCR username and license code might be incorrect")
    exit()
